        ...
        <input
          ...
          className={`
             ...
             ${props.error
              ...
              : isFocused
                ? 'border-blue-300 ring-2 ring-blue-100 shadow-lg shadow-blue-200/40'
                : hasValue
                  ? 'border-slate-200 shadow-sm'
                  : 'border-slate-200 hover:border-slate-300 hover:shadow-lg hover:shadow-blue-200/30'
            }
             focus:outline-none focus:shadow-lg focus:shadow-blue-300/50
           `}
